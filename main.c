...
void Title(int Delay) {
    ...
    sleep(Delay);
    gotoxy(10, 9);
    printf("{__ {__      {________     {____          {____    {__   {__\n\n");
    sleep(Delay);
    gotoxy(10, 11);
    printf("\n");
    sleep(Delay);
...
int HowtoPlay1() {
    ...
    Color(15);
    gotoxy(1, 3);
    printf("In the Single Player mode, objects will come out from 4 sides/walls. You are");
    gotoxy(1, 4);
    printf(" to block the object for it not to reach the side/wall across the side/wall");
    gotoxy(6, 5);
    printf("it originated. Allowing it to cross will decrease your Player size.");
    gotoxy(3, 6);
    printf("By pressing ENTER, your Player size will increase but 25 points will be");
    gotoxy(6, 7);
    printf("deducted from your score. Blocking the object will increase points.");
    Color(12);
    gotoxy(15, 9);
    printf("%c = 1 point %c = 2 points %c = 3 points %c = 4 points", 3, 4, 5, 6);
...
int HowtoPlay2() {
    ...
    Color(15);
    gotoxy(4, 3);
    printf("In the Two Player mode, an object will fall from the top. The goal is to");
    gotoxy(3, 4);
    printf("prevent the object from reaching the bottom by blocking it. Player 1 will");
    gotoxy(3, 5);
    printf("battle against Player 2. Turns will change every after a ball is dropped.");
    gotoxy(6, 6);
    printf("Player 1 goes first. Each player will be given 50 objects to block.");
    gotoxy(15, 7);
    printf("The player who gets to block more objects, wins!");
...
void GameOver() {
    ...
    while (i <= 3) {
        ...
        printf("888    888");
        gotoxy(x1, y + 3);
        printf("888         8888b.  88888b.d88b.   .d88b.");
        gotoxy(x1, y + 4);
        printf("888  88888     \"88b 888 \"888 \"88b d8P  Y8b ");
        gotoxy(x1, y + 5);
        printf("888    888 .d888888 888  888  888 88888888 ");
        gotoxy(x1, y + 6);
        printf("Y88b  d888 888  888 888  888  888 Y8b.");
        gotoxy(x1, y + 7);
        printf(" \"Y888P8P  \"Y888888 888  888  888  \"Y8888");
        ...
        printf("888     888");
        gotoxy(x2, y + 3);
        printf("888     888 888  888  .d88b.  888d888");
        gotoxy(x2, y + 4);
        printf("888     888 888  888 d8P  Y8b 888P\" ");
        gotoxy(x2, y + 5);
        printf("888     888 Y88  88P 88888888 888");
        gotoxy(x2, y + 6);
        printf("Y88b. .d88P  Y8bd8P  Y8b.     888");
        gotoxy(x2, y + 7);
        printf(" \"Y88888P\"    Y88P    \"Y8888  888");
        i++;
        sleep(600);
    }
...
void Result(float Score1, float Score2) {
    ...
    Color(15);
    gotoxy(x + 3, y + 6);
    printf("Block Percentage: ");
    printf("%.0f\%c", (Score1 / 50.0) * 100, 37);
    ...
    gotoxy(x + 3, y + 12);
    printf("Block Percentage: ");
    printf("%.0f%c", (Score2 / 50.0) * 100, 37);
